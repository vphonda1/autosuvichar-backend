...
app.get("/api/health", (req, res) => res.json({ ok: true, version: "v9-offer-seal", testMode: TEST_MODE, video: ENABLE_VIDEO, cron: ENABLE_CRON ? CRON_SCHEDULE : false, brands: Object.keys(BRANDS) }));
