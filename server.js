      ...
      try {
        ...
        if (feats.length < 16) {
          feats = [...new Set([...feats,
            ...
            "एलॉय व्हील", "मोबाइल चार्जिंग", "5-स्टेप सस्पेंशन", "स्टाइलिश ग्राफिक्स", "कम रखरखाव", "भरोसेमंद इंजन",
            "आरामदायक सीट", "मज़बूत बॉडी", "स्मूद गियर", "कम आवाज़"])].slice(0, 16);
        }
...
function buildPromoSVG(brandId, o, w, h) {
  ...
  const feats = (o.features || []).slice(0, 16);   // ⚠️ 12 → 16
  ...
  const OFFER_TOP = o.festivalMode ? h * 0.662 : h * 0.495;
  ...
  const featTop = o.festivalMode ? h * 0.716 : h * 0.658;
  ...
  const featCh = o.festivalMode ? h * 0.0175 : h * 0.024;
  ...
  const bankTop = featTop + featResult.height + (o.festivalMode ? h * 0.018 : h * 0.030);   // ⚠️ थोड़ा और नीचे
  ...
  ${bankResult.rows ? (() => {
    ...
    const ffs = Math.round(w / 40);
    const fbw2 = Math.min(w * 0.76, ft2.length * ffs * 0.50 + w * 0.06);
    const fbh2 = ffs * 1.62, fbx2 = (w - fbw2) / 2, fby2 = bankHeadY - fbh2 * 0.72;
