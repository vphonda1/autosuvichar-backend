...
async function generateImages(brandId, id, text, type, opts) {
  ...
  if ((type === "festival" || type === "gift") && global.__FESTIVE) {
    try {
      ...
      const imgs = await global.__FESTIVE.buildFestivePoster(id, {
        ...
        line3: BRANDS[brandId]?.tagline || "",
      });
      log("INFO", "[POSTER] त्यौहार वाला सजा poster बना", { id, theme: imgs._meta?.theme });
      return imgs;
    } catch (e) {
      log("WARN", "[POSTER] सजा poster नहीं बना, सादा बना रहे हैं", { msg: e.message });
    }
  }
