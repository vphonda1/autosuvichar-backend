...
app.get("/api/health", (req, res) => res.json({ ok: true, version: "v33-bg-styles", testMode: TEST_MODE, video: ENABLE_VIDEO, cron: ENABLE_CRON ? CRON_SCHEDULE : false, brands: Object.keys(BRANDS), aiImageKey: !!(process.env.GEMINI_API_KEY || process.env.GOOGLE_API_KEY), aiTextKey: !!process.env.OPENAI_API_KEY }));
...
app.post("/api/generate", async (req, res) => {
  try {
    ...
    const opts = { sticker: req.body.sticker || "", offer: req.body.offer || "", decor: req.body.decor || "", bg: req.body.bg || "auto", design: req.body.design || "auto", themeColor: fe ? fe.color : undefined, themeColor2: fe ? fe.color2 : undefined };
