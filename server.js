      ...
      try {
        ...
        if (feats.length < 18) {
          feats = [...new Set([...feats,
            ...
            "एलॉय व्हील", "मोबाइल चार्जिंग", "5-स्टेप सस्पेंशन", "स्टाइलिश ग्राफिक्स", "कम रखरखाव", "भरोसेमंद इंजन",
            "आरामदायक सीट", "मज़बूत बॉडी", "स्मूद गियर", "कम आवाज़",
            "लंबी वारंटी", "आसान सर्विस"])].slice(0, 18);
        }
...
function buildPromoSVG(brandId, o, w, h) {
  ...
  const feats = (o.features || []).slice(0, 18);   // ⚠️ अब 18 — दोनों पंक्तियाँ भरी रहें
  ...
  const OFFER_TOP = o.festivalMode ? h * 0.656 : h * 0.495;
  ...
  const featTop = o.festivalMode ? h * 0.706 : h * 0.658;
  ...
  const featCh = o.festivalMode ? h * 0.0188 : h * 0.024;
  ...
  const bankTop = featTop + featResult.height + (o.festivalMode ? h * 0.016 : h * 0.030);   // ⚠️ थोड़ा और नीचे
  const bankHeadY = bankTop;
  const bankCh = o.festivalMode ? h * 0.0215 : h * 0.028;
