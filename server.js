...
function buildSVG(brandId, text, w, h, type, opts) {
  ...
  const greetingHeader = greeting
    ? `<text x="50%" y="${headY}" text-anchor="middle" font-family="Noto Sans Devanagari, Mukta, sans-serif" font-size="${headFont}" font-weight="800" fill="#fff">${esc(greeting)}</text>`
    : "";
