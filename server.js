    ...
    try {
      ...
      if (v) {
        ...
        const o = {
          ...
          bg: "light", cutout: true, autoDecor: true, autoSeed: String(id),
        };
...
function buildPromoSVG(brandId, o, w, h) {
  ...
  ${btn3d(w * 0.05, h * 0.665, w * 0.42, h * 0.078, "एक्स-शोरूम", o.price ? "₹" + esc(o.price) : "कॉल करें", "#141414", b.accent, "#fff", Math.round(w / 40), Math.round(w / 20))}
  <!-- offers (दाएँ, 3D बटन) -->
